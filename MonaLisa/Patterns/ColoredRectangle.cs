...
{
    public class ColoredRectangle : Pattern
    {
        private static Random rand = new Random();
        private readonly Color _color;
        private readonly Rectangle _rectangle;

        public ColoredRectangle(int bitmapWidth, int bitmapHeight, Color color)
        {
        ...
        public override Bitmap AddToImage(Bitmap oldBitmap)
        {
            ...
            using (Graphics g = Graphics.FromImage(newBitmap))
            {
                ...
                g.FillRectangle(new SolidBrush(_color), _rectangle);
            }
            return newBitmap;
        }
    }
